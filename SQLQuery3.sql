CREATE DATABASE nmcnpm_teamAKAM;
...
CREATE UNIQUE INDEX uq_nguoi_dung_taikhoan
ON nguoi_dung (taiKhoan);

INSERT INTO nguoi_dung(taiKhoan, matKhau)
VALUES ('admin', 1);

-- 2. Nhân khẩu
CREATE TABLE nhan_khau(
  idNhanKhau INT IDENTITY(1,1) NOT NULL,
...
ADD CONSTRAINT CHK_nhan_khau_gioi_tinh
...
CREATE TABLE ho_khau (
  idHoKhau INT IDENTITY(1,1) NOT NULL,
...
CREATE TABLE ho_khau_nhan_khau(
   ...
   CONSTRAINT KN FOREIGN KEY (idHoKhau) REFERENCES ho_khau (idHoKhau) ON DELETE NO ACTION,
   CONSTRAINT KN2 FOREIGN KEY (idNhanKhau) REFERENCES nhan_khau (idNhanKhau) ON DELETE NO ACTION
);
...
CREATE TABLE dip_dac_biet (
  idDip INT IDENTITY(1,1) NOT NULL,
...
CREATE TABLE dip_hoc_sinh_gioi (
   idDip INT IDENTITY(1,1) PRIMARY KEY,
   nam INT NOT NULL,
   moTa NVARCHAR(255),
...
CREATE TABLE chi_tiet_dip_dac_biet(
  ...
  CONSTRAINT FK_chi_tiet_dip_dac_biet_nhan_khau FOREIGN KEY(idNhanKhau) REFERENCES nhan_khau(idNhanKhau) ON DELETE CASCADE
)
...
CREATE TABLE khai_tu(
  ...
  CONSTRAINT FK_khai_tu_nguoi_mat_nhan_khau FOREIGN KEY(idNguoiMat) REFERENCES nhan_khau(idNhanKhau) ON DELETE NO ACTION,
  CONSTRAINT FK_khai_tu_nguoi_khai_nhan_khau FOREIGN KEY(idNguoiKhai) REFERENCES nhan_khau(idNhanKhau) ON DELETE NO ACTION
)

GO

ALTER TABLE khai_tu ADD CONSTRAINT FK_khai_tu_nguoi_mat_nhan_khau_2
FOREIGN KEY (idNguoiMat) REFERENCES nhan_khau (idNhanKhau) ON DELETE CASCADE;

ALTER TABLE khai_tu ADD CONSTRAINT FK_khai_tu_nguoi_khai_nhan_khau_3
FOREIGN KEY (idNguoiKhai) REFERENCES nhan_khau (idNhanKhau) ON DELETE CASCADE;
